...
// The development-language policy — WHICH working language every role composes free text in,
// per surface. The three surfaces correspond 1:1 to where a shipped prompt composes free text
// an operator might want in a non-English language:
