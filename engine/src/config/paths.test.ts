...
const ALLOWED_1080_SITES = new Set([
  ...
  "engine/src/loop/init.test.ts:954",
  "engine/src/loop/init.test.ts:958",
  "engine/src/loop/init.test.ts:972",
  "engine/src/loop/init.test.ts:977",
  "engine/src/loop/init.test.ts:990",
  "engine/src/loop/init.test.ts:1059",
  "engine/src/loop/init.test.ts:1070",
  "engine/src/loop/init.test.ts:1129",
  "engine/src/loop/init.test.ts:1140",
  "engine/src/loop/init.test.ts:1199",
  "engine/src/loop/init.test.ts:1209",
  "engine/src/loop/init.test.ts:1210",
  "engine/src/loop/init.test.ts:1212",
  "engine/src/loop/init.test.ts:1223",
  "engine/src/loop/init.test.ts:1233",
  "engine/src/loop/init.test.ts:1234",
  "engine/src/loop/init.test.ts:1235",
  "engine/src/loop/init.test.ts:1237",
  "engine/src/loop/init.test.ts:1264",
  "engine/src/loop/init.test.ts:1291",
