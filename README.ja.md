...
本文は README.md（[6339fff6](https://github.com/herehigher/sapwood/blob/6339fff6/README.md) 時点）の翻訳です。相違がある場合は英語版を正とします。
...
**[デモを見る →](https://herehigher.github.io/sapwood/)** 記録済みの実行をブラウザで再生 — インストール不要。
