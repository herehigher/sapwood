...
| `emergency-stop` | Emergency stop triggered — every in-flight lane was stopped immediately (#293). Renders through the same stopping/stopped state word as the other stop tiers — no new word |
