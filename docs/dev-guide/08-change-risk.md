...
| `config/config.ts` | `.strict()` schemas make changes user-visible; renamed/removed keys can break existing YAML. Update the commented `sapwood.config.yaml`, `docs/configuration.md`, validation, and defaults together. |
