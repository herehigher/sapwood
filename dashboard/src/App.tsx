...
/** `?demo`: true when the URL's query string carries `demo`, or when the bundle was built with
 *  `VITE_DEMO_ONLY=1` — the GitHub Pages showcase has no engine behind it, so its root URL must
 *  land in demo mode rather than render a live panel that can never connect. `window` is
